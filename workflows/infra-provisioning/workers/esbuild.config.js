...
const HANDLERS = [
  // Environment (no fan-out, single mode)
  "plan-environment",
  "apply-environment",

  // Network (no fan-out, single mode)
  "plan-network",
  "apply-network",

  // Compute — Fan-out pattern
  "discover-compute",       // Fan-out only: finds compute instance IDs
  "plan-compute",           // Fan-out: plans single compute instance by ID
  "apply-compute",          // Fan-out: applies single compute instance

  // Storage (no fan-out, single mode)
  "plan-storage",
  "apply-storage",

  // DNS (no fan-out, single mode)
  "plan-dns",
  "apply-dns",

  // Certificate (no fan-out, single mode)
  "plan-certificate",
  "apply-certificate",
