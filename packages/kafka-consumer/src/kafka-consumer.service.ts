...
export class KafkaConsumerService implements OnModuleDestroy {
  ...
  async subscribe(subscription: TopicSubscription): Promise<void> {
    ...
    // Subscribe with retries. Kafka may report
    // "This server does not host this topic-partition" briefly after
    // auto-creating a topic, until the metadata propagates. Retry transparently.
    const maxAttempts = 5;
